...
export async function getServerSideProps(context: any) {
  const articles: Repo[] = await fetch(`https://lcw99.github.io/newparty-cms/article/articles.json`).then(
    (res) => res.json()
  );
  const docs: Doc[] = await fetch(`https://lcw99.github.io/newparty-cms/documents.json`).then((res) =>
    res.json()
  );
